...
class LocalNotificationService 
{
  ...
  static onTap(NotificationResponse notificationResponse) async 
  {
    ...
    // await notificationCases(data['type'], data['model_id']);

    // notificationCases(data['type'], int.parse(notificationResponse.payload!));
  ...
  //basic Notification
  static void showBasicNotification(Map<String, dynamic> data) async {
